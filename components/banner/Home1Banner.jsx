            ...
            <div className="col-lg-6 d-flex align-items-xxl-start align-items-center">
              <div className="banner-content">
                <span className="arabic" dir={dir}>
                  ...
                  { lang === 'en' ? data?.heading : data?.headingArabic}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={14}
                    height={14}
                ...
                <h1 className="arabic" dir={dir}>   { lang === 'en' ? data?.title : data?.titleArabic} </h1>
                <p className="arabic  !text-xl" dir={dir}>
                  { lang === 'en' ? data?.desc : data?.descArabic}
                </p>
