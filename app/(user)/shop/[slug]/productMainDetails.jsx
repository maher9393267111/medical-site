              ...
              <div className="product-details-img">
                <div className="tab-content" id="v-pills-tabContent">
                  <div
                    ...
                    id={`v-pills-img${productdata?.images[0]}`}
                    // id="v-pills-img1"
                    role="tabpanel"
                  >
...
return (
                  ...
                  key={index}
                    ...
                    role="tabpanel"
                    aria-labelledby={`v-pills-img${index}-tab`}
                  >
                    <div className="product-details-tab-img">
                      <img 
                      src={urlFor(item)?.url()} 
...
return (
                  ...
                  className="nav-item" role="presentation">
                    <button
                      ...
                      id="v-pills-img1-tab"
                      data-bs-toggle="pill"
                      data-bs-target={`#v-pills-img${index}`}
                      type="button"
                      role="tab"
                      aria-controls={`v-pills-img${index}`}
                      aria-selected="true"
                    >
                      <img 
                        id={`v-pills-img${index}`}
            ...
            <div dir={dir} className="col-lg-6">
              <div className="product-details-content">
                <h1  className=" arabic">{lang === 'en' ? productdata?.title : productdata?.titlear}</h1>
                ...
                <div>
                <div dir={dir} className=" mt-4 mx-2 marks arabic">
                  <PortableText
                    value={lang === 'en' ? productdata?.body : productdata?.bodyar}
